        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class='nav-item px-2'><a class='nav-link' href='{{route("main")}}'> Visit Home page</a></li>
                    ...
                    <li class='nav-item px-2'><a class='nav-link' href='{{route("main")}}'> Site Settings</a></li>
