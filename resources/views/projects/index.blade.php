...
<html lang="en">
   ...
   <meta name="csrf-token" content="vjAz3Bu0DeJxB6kMxwVQ35TLJyWZLzJ2s2cdIyg0">
   <title>Projects - Baron & Cabot</title>
   ...
   <link rel="icon" type="image/png" sizes="192x192" href="https://baroncabot.com/assets/favicons/android-icon-192x192.png">
   <link rel="icon" type="image/png" sizes="32x32" href="https://baroncabot.com/assets/favicons/favicon-32x32.png">
   <link rel="icon" type="image/png" sizes="96x96" href="https://baroncabot.com/assets/favicons/favicon-96x96.png">
   <link rel="icon" type="image/png" sizes="16x16" href="https://baroncabot.com/assets/favicons/favicon-16x16.png">
   ...
   <body>
      ...
      <!-- header start -->
      <header class="header-1 fixed-header">
   <div class="container">
      <div class="row">
         <div class="col">
            <div class="menu">
                           ...
                           <li class="back-btn">
                              <div class="mobile-back text-end">
                                 ...
                                 <i aria-hidden="true" class="fa fa-angle-right ps-2"></i>
                                                                                                                           ...
                                                                                                                           <li >
                                                                           <a href="https://baroncabot.com/projects" class="nav-link menu-title">Projects</a>

                                                                     </li>
                                                                                                <li >
                                                                           <a href="https://baroncabot.com/services" class="nav-link menu-title">Services</a>
                                                                           ...
                                                                           <ul class="nav-submenu menu-content">
                                                                                       <li>
                                                                                                   <a href="https://baroncabot.com/about/who-we-are">Who we are</a>
                                                                                             </li>
                                                                                       <li>
                                                                                                   <a href="https://baroncabot.com/about/due-diligence">Due Diligence</a>
                                                                                             </li>
                                                                                       <li>
                                                                                                   <a href="https://baroncabot.com/about/faqs">Faq's</a>
                                                                                             </li>
                                                                                 </ul>
                                                                     </li>
                                                                                                <li >
                                                                           <a href="https://baroncabot.com/our-team" class="nav-link menu-title">Our Team</a>

                                                                     </li>
                                                                                                <li >
                                                                           <a href="https://baroncabot.com/blog" class="nav-link menu-title">Blog</a>

                                                                     </li>
                                                                                                <li >
                                                                           <a href="https://baroncabot.com/contact" class="nav-link menu-title">Contact</a>
                  ...
                  <li class="right-menu color-6">
                     <ul class="nav-menu">
                        <li class="dropdown language">
                           <a href="tel:+442036951739" class="btn btn-outline-white">
                              <i class="fas fa-phone-alt"></i> +44 20 3695 1739
                           </a>
                        </li>
                     </ul>
                  </li>
   ...
   <section class="breadcrumb-section p-0">
      <img src="https://baroncabot.com/assets/images/inner-background.jpg" class="bg-img img-fluid" alt="title image">
      <div class="container">
         <div class="breadcrumb-content">
            <div>
               ...
               <nav aria-label="breadcrumb" class="theme-breadcrumb">
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="https://baroncabot.com">Home</a></li>
               ...
               <div class="property-2 row column-sm zoom-gallery property-label property-grid">
                  <div class="col-xl-12 col-md-12 description">
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/the-muller-yard/details">
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <a href="https://baroncabot.com/project/the-muller-yard/details">
                                 <h3>The Muller Yard</h3>
                              </a>
                              <h6>£199,995*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q4 2023</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/the-muller-yard/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/london-square-watford/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/qpZ9BI006.jpg" class="bg-img" alt="London Square Watford" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <a href="https://baroncabot.com/project/london-square-watford/details">
                                 <h3>London Square Watford</h3>
                              </a>
                              <h6>£300,000*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Completed</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/london-square-watford/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/the-silk-yard/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/IbsiApxxxxxx.jpg" class="bg-img" alt="The Silk Yard" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <h6>£139,000*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q2 2024</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/the-silk-yard/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/cluny-mews/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/5WlPVnIMG-20230705-WA0006 (2).jpg" class="bg-img" alt="Cluny Mews" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <div class="property-btn d-flex">
                                 ...
                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/cluny-mews/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/heathside/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/HY5Ot8Heathside-07.jpg" class="bg-img" alt="Heathside" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <div class="property-btn d-flex">
                                 ...
                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/heathside/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/sky-gardens/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/d02iv2SKYGARDENS-PORTAL.png" class="bg-img" alt="Sky Gardens" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <div class="property-btn d-flex">
                                 ...
                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/sky-gardens/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/apex-lofts-digbeth/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/FEG3hJWeb_Apex_Lofts-4.jpg" class="bg-img" alt="APEX Lofts Digbeth" style="height: 256px">
                                                                     </a>
                              </div>

                           </div>
                           <div class="property-details" style="min-height: 251px;">
                              <span class="font-roboto">Birmingham</span>
                              <a href="https://baroncabot.com/project/apex-lofts-digbeth/details">
                                 <h3>APEX Lofts Digbeth</h3>
                              </a>
                              <h6>£236,198*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q2 2023</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/apex-lofts-digbeth/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/park-avenue-placedeptford/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/3IVg9B03.jpg" class="bg-img" alt="Park Avenue Place,Deptford" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              <span class="font-roboto">London</span>
                              <a href="https://baroncabot.com/project/park-avenue-placedeptford/details">
                                 <h3>Park Avenue Place,Deptford</h3>
                              </a>
                              <h6>£400,000*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q4 2023</span></h5>
                              ...
                              <div class="property-btn d-flex">
                                 ...
                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/park-avenue-placedeptford/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/pavilion-wharf/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/IJ47JIPavilion-Wharf---01.png" class="bg-img" alt="Pavilion Wharf" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              <span class="font-roboto">Manchester</span>
                              <a href="https://baroncabot.com/project/pavilion-wharf/details">
                                 <h3>Pavilion Wharf</h3>
                              </a>
                              <h6>£179,950*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q3 2024</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/pavilion-wharf/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/victoria-house/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/HG1XsjSALBOY_VICTORIA_HOUSE_EXTERIOR_DRONE_V02_FINAL_HIGH_RES_.jpg" class="bg-img" alt="Victoria House" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <div class="property-btn d-flex">
                                 ...
                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/victoria-house/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/viadux/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/aW3n5SViadux-daytime.jpg" class="bg-img" alt="Viadux" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <div class="property-btn d-flex">
                                 ...
                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/viadux/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/gunsmith-house/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/heO81cgunmdsfsdfd.jpg" class="bg-img" alt="Gunsmith House" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              <span class="font-roboto">Birmingham</span>
                              <a href="https://baroncabot.com/project/gunsmith-house/details">
                                 <h3>Gunsmith House</h3>
                              </a>
                              <h6>£219,500*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q1 2024</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/gunsmith-house/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/boulevard/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/8U5gGqbludsad.jpg" class="bg-img" alt="Boulevard" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              ...
                              <h6>£199,950*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q4 2024</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/boulevard/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/phoenix/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/gEyrVEphoenix.jpg" class="bg-img" alt="Phoenix" style="height: 256px">
                                                                     </a>
                              </div>

                           </div>
                           <div class="property-details" style="min-height: 251px;">
                              <span class="font-roboto">Cambridge</span>
                              <a href="https://baroncabot.com/project/phoenix/details">
                                 <h3>Phoenix</h3>
                              </a>
                              <h6>£350,000*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Q3 2023</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/phoenix/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/broadoaks-phase-3/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/otvDksCGI_2.png" class="bg-img" alt="Broadoaks Phase 3" style="height: 256px">
                                                                     </a>
                              </div>

                           </div>
                           <div class="property-details" style="min-height: 251px;">
                              <span class="font-roboto">Solihull</span>
                              <a href="https://baroncabot.com/project/broadoaks-phase-3/details">
                                 <h3>Broadoaks Phase 3</h3>
                              </a>
                              <h6>£195,000*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">Completed</span></h5>
                              ...
                              <div class="property-btn d-flex">
                                 ...
                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/broadoaks-phase-3/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="property-box">
                           <div class="property-image">
                              <div class="property-slider">
                                 <a href="https://baroncabot.com/project/heaton-house-jewellery-qtr/details">
                                                                                                               <img src="https://cms.baroncabot.com/media/products/cfPbCf42.jpg" class="bg-img" alt="Heaton House, Jewellery Qtr" style="height: 256px">
                                                                     </a>
                              </div>
                           ...
                           <div class="property-details" style="min-height: 251px;">
                              <span class="font-roboto">Birmingham</span>
                              <a href="https://baroncabot.com/project/heaton-house-jewellery-qtr/details">
                                 <h3>Heaton House, Jewellery Qtr</h3>
                              </a>
                              <h6>£205,920*</h6>
                              <h5><b>Completion :</b> <span class="text-primary">August 2022</span></h5>


                              <div class="property-btn d-flex">

                                 <button type="button"  onclick="document.location='https://baroncabot.com/project/heaton-house-jewellery-qtr/details'" class="btn btn-dashed btn-pill  btn-block color-2 mt-3">Details</button>
                              </div>
                           </div>
                        </div>
                     </div>
...
<!-- Livewire Component wire-end:QKSO8K4MCpbUnJr7nMm8 -->  <!-- property grid end -->
         ...
         <div class="row">
            <div class="col-xl-3">
               <div class="footer-details text-center">
                  ...
                  <p>We invest ourselves. We help our friends and family invest. For years we have helped investors invest in their first to fifty-first property with a simple approach and detailed due diligence process.</p>
                  <ul class="icon-list">
                     <li><a href="https://www.facebook.com/baronandcabot" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                     <li><a href="https://www.linkedin.com/company/baron-cabot-research" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                     <li><a href="https://twitter.com/BaronCabotLtd" target="_blank"><i class="fab fa-twitter"></i></a></li>
                     <li><a href="https://www.instagram.com/baron.cabot/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                 </ul>
               </div>
            </div>
            <div class="col-xl-9">
                  ...
                  <div class="col-lg-3 col-md-4">
                     <div class="footer-links footer-left-space">
                        ...
                        <ul class="footer-content">
                           <li>
                              <a href="https://baroncabot.com/investment-locations/birmingham-property-investment">Birmingham</a>
                           </li>
                           <li>
                              <a href="https://baroncabot.com/investment-locations/manchester-property-investment">Manchester</a>
                           </li>
                           <li>
                              <a href="https://baroncabot.com/investment-locations/leeds-property-investment">Leeds</a>
                           </li>
                           <li>
                              <a href="https://baroncabot.com/investment-locations/liverpool-property-investment">Liverpool</a>
                           </li>
                        </ul>
                     </div>
                  </div>
                     ...
                     <div class="footer-links">
                        ...
                        <div class="footer-content">
                           ...
                           <form method="post" action="https://baroncabot.com/save/newsletter/submit">
                              <input type="hidden" name="_token" value="vjAz3Bu0DeJxB6kMxwVQ35TLJyWZLzJ2s2cdIyg0">                              <div class="input-group">
                        ...
                        <div>
                           <div class="media">
                              <div class="media-body">
                                 ...
                                 <p class="font-roboto">
                                    <a href="tel:+442036951739">Phone: +44 20 3695 1739<br>
                                    Salisbury House 29 Finsbury Circus UNIT FC.394 London England EC2M 5QQ
                                    </a>
                                 </p>
                              </div>
                           </div>
                        ...
                        <div>
                           <div class="media">
                              <div class="media-body">
                                 ...
                                 <p class="font-roboto"><a href="#">Fifth Floor. Kindaruma Road. Top Plaza. Nairobi.</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="row">
                     <form class="col" id="leadsForm" method="POST" action="https://baroncabot.com/save/website/inquiry">
                        <input type="hidden" name="_token" value="vjAz3Bu0DeJxB6kMxwVQ35TLJyWZLzJ2s2cdIyg0">                        <div class="row">
                           <div class="col">
                              <div class="form-group">
                        ...
                        <div class="col">
                           ...
                           <input type="hidden" name="page" value="Projects" class="form-control" required>
                        </div>
